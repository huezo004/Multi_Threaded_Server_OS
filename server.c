...
void  multipleRequests(void* socket_talk);
...
int main(int argc, char **argv)
{
    ...
    //threadpool tpool= create_threadpool(50);
    ...
    while(1) {
        ...
        dispatch(tpool, multipleRequests, (void *)socket_talk);  /* implementation */
    }
}
...
void  multipleRequests(void* tt){
    
    char *request = NULL;
    char *response = NULL;

    int socket_talk= (int)tt; 
